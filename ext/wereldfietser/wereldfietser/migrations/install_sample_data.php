...
class install_sample_data extends \phpbb\db\migration\migration
{
	...
	{
		return $this->config->offsetExists('wereldfietser_wereldfietser_sample_int');
	}
	...
	public function update_data()
	{
		return [
			...
			['config.add', ['wereldfietser_wereldfietser_sample_int', 0]],
			['config.add', ['wereldfietser_wereldfietser_sample_str', '']],

			// Add a new config_text table setting
			['config_text.add', ['wereldfietser_wereldfietser_sample', '']],

			// Add new permissions
			['permission.add', ['a_new_wereldfietser_wereldfietser']], // New admin permission
			['permission.add', ['m_new_wereldfietser_wereldfietser']], // New moderator permission
			['permission.add', ['u_new_wereldfietser_wereldfietser']], // New user permission
			...
			['permission.permission_set', ['ROLE_ADMIN_FULL', 'a_new_wereldfietser_wereldfietser']], // Give ROLE_ADMIN_FULL a_new_wereldfietser_wereldfietser permission
			['permission.permission_set', ['ROLE_MOD_FULL', 'm_new_wereldfietser_wereldfietser']], // Give ROLE_MOD_FULL m_new_wereldfietser_wereldfietser permission
			['permission.permission_set', ['ROLE_USER_FULL', 'u_new_wereldfietser_wereldfietser']], // Give ROLE_USER_FULL u_new_wereldfietser_wereldfietser permission
			['permission.permission_set', ['ROLE_USER_STANDARD', 'u_new_wereldfietser_wereldfietser']], // Give ROLE_USER_STANDARD u_new_wereldfietser_wereldfietser permission
			['permission.permission_set', ['REGISTERED', 'u_new_wereldfietser_wereldfietser', 'group']], // Give REGISTERED group u_new_wereldfietser_wereldfietser permission
			['permission.permission_set', ['REGISTERED_COPPA', 'u_new_wereldfietser_wereldfietser', 'group', false]], // Set u_new_wereldfietser_wereldfietser to never for REGISTERED_COPPA

			// Add new permission roles
			['permission.role_add', ['wereldfietser admin role', 'a_', 'a new role for admins']], // New role "wereldfietser admin role"
			['permission.role_add', ['wereldfietser moderator role', 'm_', 'a new role for moderators']], // New role "wereldfietser moderator role"
			['permission.role_add', ['wereldfietser user role', 'u_', 'a new role for users']], // New role "wereldfietser user role"
